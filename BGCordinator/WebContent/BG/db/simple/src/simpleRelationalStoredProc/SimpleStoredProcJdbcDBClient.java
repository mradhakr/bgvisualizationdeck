...
package simpleRelationalStoredProc;
 ...
 *
 */
public class SimpleStoredProcJdbcDBClient extends DB implements JdbcDBClientConstants {
		...
		try {
			...
			stmt.execute("CREATE OR REPLACE PROCEDURE acceptfriend " +
							"("+ 
						         ...
						         " p_STATUS   IN FRIENDSHIP.STATUS%TYPE   "  +
						     ")" +
						"AS "+ 
						"BEGIN "+ 
